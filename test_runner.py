...
test_suites = {
    'file_selector': ['file_selector_tests', 'file_selector_tests']
}
...
class ShowGotoRelatedFileTestSuites(sublime_plugin.WindowCommand):
...
class FileSelectorTestsCommand(sublime_plugin.WindowCommand):
